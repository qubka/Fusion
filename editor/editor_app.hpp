...
public:
    ...
    EditorApp(const CommandLineArgs& args) : Application{"Vulkan Demo Scene - � 2016 by Sascha Willems", args} {
        size.width = 1280;
        size.height = 720;
    ...
    void updateUniformBuffers() {
        uboVS.projection = camera.getViewProjection();
        uboVS.view = camera.getView();
        uboVS.model = glm::mat4{1};
