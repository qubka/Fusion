...
DebugSubrender::DebugSubrender(Pipeline::Stage pipelineStage)
    ...
    PipelineGraphics{pipelineStage,
                     {"engine/assets/shaders/debug/line.vert", "engine/assets/shaders/debug/line.frag"},
    ...
    PipelineGraphics{pipelineStage,
                     ...
                     VK_POLYGON_MODE_FILL},
    PipelineGraphics{pipelineStage,
                     {"engine/assets/shaders/debug/point.vert", "engine/assets/shaders/debug/point.frag"},
