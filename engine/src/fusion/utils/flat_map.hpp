...
#define CMCSTL2_CONCEPTS 201703L <= __cplusplus && __has_include(<stl2/ranges.hpp>)
...
namespace std {
    ...
    struct __flat_map_iterator
    {
        ...
        using value_type =
                pair<__remove_cvref_t<_KeyRef>, __remove_cvref_t<_TRef>>;
    ...
    template<typename T>
    struct flat_container {
        using type = T;
    };
    template<>
    struct flat_container<bool> {
        using type = char;
    };

    //using non_boolean_t = conditional_t<std::is_same_v<T, bool>, char, T>
    ...
    template<
            ...
            class _MappedContainer = vector<typename flat_container<_Value>::type>>
    class flat_map
    {
        using _T = typename flat_container<_Value>::type;
    ...
    public:
        ...
        iterator try_emplace(
                const_iterator __hint, const key_type & __k, _Args &&... __args)
        {
        ...
        template<
                ...
                class _Enable = enable_if_t<
                        ...
                        is_constructible<mapped_type, _M &&>::value>>
        iterator
        insert_or_assign(const_iterator hint, const key_type & __k, _M && __obj)
        {
        ...
        template<
                ...
                class _Enable = enable_if_t<
                        ...
                        is_constructible<mapped_type, _M &&>::value>>
        iterator
        insert_or_assign(const_iterator hint, key_type && __k, _M && __obj)
        {
