...
namespace fst {
    ...
    public:
        ...
        using size_type = typename fst::flatmap_storage<Key, Value>::size_type;
        ...
        using fst::flatmap_storage<Key, Value>::clear;
        using fst::flatmap_storage<Key, Value>::empty;
        using fst::flatmap_storage<Key, Value>::size;
        using fst::flatmap_storage<Key, Value>::begin;
        using fst::flatmap_storage<Key, Value>::end;
        using fst::flatmap_storage<Key, Value>::cbegin;
        using fst::flatmap_storage<Key, Value>::cend;
    ...
    public:
        using key_type = Key;
        using mapped_type = Value;
        using key_storage = typename fst::split_flatmap_storage<Key, Value>::key_storage;
        using value_storage = typename fst::split_flatmap_storage<Key, Value>::value_storage;
        using value_type = typename fst::split_flatmap_storage<Key, Value>::value_type;
        using reference = typename fst::split_flatmap_storage<Key, Value>::reference;
        using pointer = typename fst::split_flatmap_storage<Key, Value>::pointer;
        using iterator = typename fst::split_flatmap_storage<Key, Value>::iterator;
        using const_iterator = typename fst::split_flatmap_storage<Key, Value>::const_iterator;
        using size_type = typename fst::split_flatmap_storage<Key, Value>::size_type;
        ...
        using fst::split_flatmap_storage<Key, Value>::clear;
        using fst::split_flatmap_storage<Key, Value>::empty;
        using fst::split_flatmap_storage<Key, Value>::size;
        using fst::split_flatmap_storage<Key, Value>::begin;
        using fst::split_flatmap_storage<Key, Value>::end;
        using fst::split_flatmap_storage<Key, Value>::cbegin;
        using fst::split_flatmap_storage<Key, Value>::cend;
        ...
        const key_storage& keys() const { return this->m_keys; }

        const value_storage& values() const { return this->m_values; }

        bool operator==(const unordered_split_flatmap& rhs) const {
            return this->m_keys.size() == rhs.m_keys.size() && this->m_values.size() == rhs.m_values.size() && this->m_keys == rhs.m_keys && this->m_values == rhs.m_values;
        }
    ...
    private:
        using fst::flatmap_storage<Key, Value>::inner;
    ...
    public:
        ...
        template<typename V, typename I, typename = std::enable_if_t<
    ...
    class fst::split_flatmap_storage<Key, Value>::iterator_type {
        ...
        friend class fst::split_flatmap_storage<Key, Value>;
