...
namespace fe {
    class Mesh2Subrender final : public Subrender {
    public:
        explicit Mesh2Subrender(Pipeline::Stage pipelineStage);
        ~Mesh2Subrender() override = default;

    private:
        struct/* FUSION_MEM_ALIGN*/ Light {
