...
glm::vec4 ImGuiUtilities::SelectedColour = glm::vec4{1.0f};
glm::vec4 ImGuiUtilities::IconColour = glm::vec4{1.0f};

void ImGuiUtilities::SetTheme(ImGuiUtilities::Theme theme) {
