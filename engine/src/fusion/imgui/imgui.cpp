...
void ImGuis::UpdateKeyModifiers(int mods) {
...
int ImGuis::TranslateUntranslatedKey(int key, int scancode) {
...
ImGuiKey ImGuis::KeyToImGuiKey(int key) {
    switch (key) {
