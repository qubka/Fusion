...
public:
    ...
    void setImageLayout(vk::CommandBuffer cmdbuffer,
        ...
        imageMemoryBarrier.srcAccessMask = vkx::util::accessFlagsForLayout(oldImageLayout);
        imageMemoryBarrier.dstAccessMask = vkx::util::accessFlagsForLayout(newImageLayout);
        vk::PipelineStageFlags srcStageMask = vkx::util::pipelineStageForLayout(oldImageLayout);
        vk::PipelineStageFlags destStageMask = vkx::util::pipelineStageForLayout(newImageLayout);
        // Put barrier on top
...
protected:
    ...
    void buildDevice() {
        // Vulkan device
        vkx::queues::DeviceCreateInfo deviceCreateInfo;
