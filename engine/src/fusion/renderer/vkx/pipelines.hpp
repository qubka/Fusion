...
namespace vkx { namespace pipelines {
    ...
    public:
        PipelineColorBlendAttachmentState(vk::Bool32 blendEnable_ = 0,
                                          ...
                                          vk::ColorComponentFlags colorWriteMask_ = vkx::util::fullColorWriteMask())
            : Parent(blendEnable_,
    ...
    public:
        ...
        vk::PipelineShaderStageCreateInfo& loadShader(const std::string& fileName, vk::ShaderStageFlagBits stage, const char* entryPoint = "main") {
            vk::PipelineShaderStageCreateInfo shaderStage = vkx::shaders::loadShader(device, fileName, stage, entryPoint);
