...
private:
    ...
    void updateViewMatrix() {
        ...
        rotM = glm::rotate(rotM, glm::radians(rotation.x), vec3::right);
        rotM = glm::rotate(rotM, glm::radians(rotation.y), vec3::up);
        rotM = glm::rotate(rotM, glm::radians(rotation.z), vec3::forward);
