...
namespace fe {
    ...
    public:
         ...
         */
        static void ReadBytes(const fs::path& filepath, const std::function<void(gsl::span<const uint8_t>)>& handler);
         ...
         */
        static bool WriteBytes(const fs::path& filepath, gsl::span<const uint8_t> buffer);
